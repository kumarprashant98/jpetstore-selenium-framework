...
//Waits
     ...
     * @return WebElement object
     */
    public WebElement waitTillElementExist(By by, int timeout) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeout));
        try
        {
            return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(by)).stream().findFirst().get();
        }
        catch(Exception e)
        {
            return null;
    ...
    public WebElement waitTillElementIsRefreshed(By by)
    {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(Constants.WEBDRIVER_WAIT_DURATION));
